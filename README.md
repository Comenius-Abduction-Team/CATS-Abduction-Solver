...
#### Output:
* *-json: \<boolean\>* whether a json file containing information for [HS-tree Visualizer](https://m1chaelat.github.io/HSTreeVisualizer/) should be created. *false* by default.
