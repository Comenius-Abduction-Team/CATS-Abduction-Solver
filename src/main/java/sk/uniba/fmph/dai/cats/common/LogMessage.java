...
public class LogMessage {
    ...
    public final static String INFO_NOTHING_TO_EXPLAIN = "The observation is already entailed!";
    public final static String INFO_EMPTY_MODEL_FOUND_NO_EXPLANATIONS = "Empty model found. The observation has no explanation within the given set of abducibles.";
