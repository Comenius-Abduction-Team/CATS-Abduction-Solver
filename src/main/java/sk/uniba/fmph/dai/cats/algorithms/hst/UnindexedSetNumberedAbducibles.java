...
public class UnindexedSetNumberedAbducibles implements INumberedAbducibles {
    ...
    public UnindexedSetNumberedAbducibles(TransformedAbducibles transformedAbducibles) {
